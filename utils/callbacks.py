...
class LossHistory():
    ...
    def loss_plot(self):
        ...
        try:
            # Delay scipy import to avoid issues
            import scipy.signal
...
class EvalCallback():
    ...
    def get_miou_png(self, image):
        # Convert to RGB to avoid errors with grayscale images
    ...
    def on_epoch_end(self, epoch, model_eval):
        if epoch % self.period == 0 and self.eval_flag:
            ...
            _, IoUs, _, _ = compute_mIoU(gt_dir, pred_dir, self.image_ids, self.num_classes, None)  # Compute mIoU
