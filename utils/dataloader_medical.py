...
class UnetDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        png         = np.array(png)
        #-------------------------------------------------------#
        #   Label processing differs from VOC
        #   Set pixels <= 127.5 as target pixels.
        #-------------------------------------------------------#
    ...
    def get_random_data(self, image, label, input_shape, jitter=.3, hue=.1, sat=0.7, val=0.3, random=True):
        ...
        #------------------------------#
        #   Get image height/width and target height/width
        #------------------------------#
        iw, ih  = image.size
        h, w    = input_shape
        ...
        #------------------------------------------#
        #   Scale image and distort length/width
        #------------------------------------------#
        ...
        #------------------------------------------#
        #   Add gray bars to extra image parts
        #------------------------------------------#
        ...
        #   Calculate color transformation parameters
        #---------------------------------#
